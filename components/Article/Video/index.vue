<template>
  <ui-container v-if="mainVideo" class="noPaddingTop">
    <div :class="[
      $style.mainVideo,
      $props.order === 0 ? $style.fullWidth : ''
      ]">
      <video ref="mainVideo" controls :poster="hasPoster ? mainVideoPoster : ''" loop playsinline webkit-playinginline id="mainVideo">
